...
pub fn EmailView(
    ...
    rsx! {
        div {
            ...
            // Email header
            div {
                style: "flex-shrink:0; padding:16px 24px 12px; border-bottom:1px solid #1f2937; background:rgba(17,24,39,0.3);",
            ...
            // Action bar
            div {
                style: "flex-shrink:0; padding:8px 24px; border-bottom:1px solid #1f2937; display:flex; gap:6px; background:rgba(17,24,39,0.15);",
                button {
                    style: "{ACTION_BTN}",
